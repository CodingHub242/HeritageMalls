...
//     return from(new Promise<Item[]>((resolve, reject) => {
//       if (!this.db) {
//         reject('Database not initialized');
//         return;
//       }
...
//     return from(new Promise<Category[]>((resolve, reject) => {
//       if (!this.db) {
//         reject('Database not initialized');
//         return;
//       }
...
//               version: 1
//             });
//             request.onerror = () => console.error('Error adding new server category:', serverItem);
//           }
//         } else {
...
//         // Then sync server data with offline storage
//         const lastItemSync = await this.getLastSyncTime('items').toPromise();
//         const lastCategorySync = await this.getLastSyncTime('categories').toPromise();
